...
//    public final int worldHeight = tileSize * maxWorldRow;
    ...
    public SuperObject obj[] = new SuperObject[10]; // create 10 objects at same time
...
//        gameState = playState;
    ...
    public void restart()
    {
        ...
        aSetter.setNPC();
        ui.playTime = 0;
        player.correctMulDec = 0;
        player.totalMulDec = 0;
        player.correctDivDec = 0;
        player.totalDivDec = 0;
        player.correctMulFrac = 0;
        player.totalMulFrac = 0;
        player.correctDivFrac = 0;
        player.totalDivFrac = 0;
    }
